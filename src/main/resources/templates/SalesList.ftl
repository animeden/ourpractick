...
<script>
    ...
    function src() {
        ...
        if (f == "http://localhost:1821/web/sales/sort" || f == "https://animedenapp.herokuapp.com/web/administration/sort")
        {
            document.getElementById("sr").style.display = 'none';
            document.getElementById("nsr").style.display = 'flex';
        }
        if (f == "http://localhost:1821/web/sales/get/list" || f == "https://animedenapp.herokuapp.com/web/administration/get/list")
        {
