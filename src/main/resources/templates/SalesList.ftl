...
<script>
    ...
    function src() {
        ...
        if (f == "http://localhost:1821/web/sales/sort" || f == "https://animedennekohimeapp.herokuapp.com/web/sales/sort")
        {
            document.getElementById("sr").style.display = 'none';
            document.getElementById("nsr").style.display = 'flex';
        }
        if (f == "http://localhost:1821/web/sales/get/list" || f == "https://animedennekohimeapp.herokuapp.com/web/sales/get/list")
        {
        ...
        if(f == "https://animedennekohimeapp.herokuapp.com/web/sales/sort" || f == "https://animedennekohimeapp.herokuapp.com/web/sales/get/list")
        {
