...
<script>
    ...
    function src() {
        ...
        if (f == "http://localhost:1821/web/customers/sort" || f == "https://animedenapp.herokuapp.com/web/customers/sort")
        {
            document.getElementById("sr").style.display = 'none';
            document.getElementById("nsr").style.display = 'flex';
        }
        if (f == "http://localhost:1821/web/customers/get/list" || f == "https://animedenapp.herokuapp.com/web/customers/get/list")
        {
        ...
        if(f == "https://animedenapp.herokuapp.com/web/customers/sort" || f == "https://animedenapp.herokuapp.com/web/customers/get/list")
        {
