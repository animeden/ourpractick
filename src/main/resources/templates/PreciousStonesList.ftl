...
<script>
    ...
    function src() {
        ...
        if (f == "http://localhost:1821/web/preciousStones/sort" || f == "https://animedenapp.herokuapp.com/web/preciousStones/sort")
        {
            document.getElementById("sr").style.display = 'none';
            document.getElementById("nsr").style.display = 'flex';
        }
        if (f == "http://localhost:1821/web/preciousStones/get/list" || f == "https://animedenapp.herokuapp.com/web/preciousStones/get/list")
        {
        ...
        if(f == "https://animedenapp.herokuapp.com/web/preciousStones/sort" || f == "https://animedenapp.herokuapp.com/web/preciousStones/get/list")
        {
