...
<script>
    ...
    function src() {
        ...
        if (f == "http://localhost:1821/web/materials/sort" || f == "https://animedennekohimeapp.herokuapp.com/web/materials/sort")
        {
            document.getElementById("sr").style.display = 'none';
            document.getElementById("nsr").style.display = 'flex';
        }
        if (f == "http://localhost:1821/web/materials/get/list" || f == "https://animedennekohimeapp.herokuapp.com/web/materials/get/list")
        {
        ...
        if(f == "https://animedennekohimeapp.herokuapp.com/web/materials/sort" || f == "https://animedennekohimeapp.herokuapp.com/web/materials/get/list")
        {
